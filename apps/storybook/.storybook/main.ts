...
const config: StorybookConfig = {
  stories: [
    ...
    '../../../packages/ui/src/molecules/context-menu/**/*.stories.@(ts|tsx|mdx)',
    ...
    '../../../packages/ui/src/molecules/navigation-menu/**/*.stories.@(ts|tsx|mdx)',
    ...
    '../../../packages/ui/src/organisms/data-table/**/*.stories.@(ts|tsx|mdx)',
    ...
    '../../../packages/ui/src/organisms/wizard/**/*.stories.@(ts|tsx|mdx)'
  ],
