...
### Molecules shipped in `0.2.0` – `0.8.0`
...
`Avatar`/`IconButton` atoms) in `0.8.0`.
...
snapshots. `0.8.0` ships 45 test files — one per component — all green in CI on every push and pull
request.
