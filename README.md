...
**Current release: `0.19.0` — atoms, forty molecules, plus fourteen organisms.**
...
### Organisms shipped in `0.13.0` – `0.19.0`
...
`RichTextViewer` (renders saved editor output read-only) — in `0.19.0`.
...
snapshots. `0.19.0` ships 84 test files — one per component — all green in CI on every push and pull
request.
